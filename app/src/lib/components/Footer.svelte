<footer class="bg-primary" aria-labelledby="footer-heading">
	...
	<div class="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-12">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div class="mt-12 grid grid-cols-2 content-end gap-8 xl:col-span-2 xl:mt-0">
				<div class="flex flex-col space-y-4">
					...
					<h3 class="text-sm font-semibold uppercase tracking-wider text-white">Privacy Policy</h3>
					<h3 class="text-sm font-semibold uppercase tracking-wider text-white">
						Ethics & Guidelines
					</h3>
				...
				<div class="grid content-end">
					<p class="text-xs font-semibold uppercase text-white lg:text-right">
						Terms of use • Privacy Policy • Cookie Policy • <br />Do not sell my personal
						information • <br />Advertise • Help • Feedback
					</p>
				</div>
			</div>
		</div>
		<div class="mt-12 border-t border-white pt-8">
			<p class="text-xs font-semibold uppercase text-white xl:text-right">
				&copy; 2023 VSU Amaranth. All rights reserved.
			</p>
		</div>
	</div>
</footer>
